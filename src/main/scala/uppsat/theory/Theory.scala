...
trait Theory {
    ...
    def symbolToSMTLib(symbol : ConcreteFunctionSymbol)(implicit translator : Option[SMTTranslator] = None) : String
    def sortToSMTLib(sort : ConcreteSort)(implicit translator : Option[SMTTranslator] = None) : String    
