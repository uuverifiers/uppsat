...
(assert (= equal0 (fp.eq .14 x)))
(assert (= equal1 (fp.eq .11 .12)))
(assert (= equal13 (fp.eq .11 z)))
(assert (= equal3 (fp.eq .14 .15)))
(assert (= equal6 (fp.eq .10 ((_ to_fp 11 53) RTZ (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= equal7 (fp.eq .12 y)))
(assert (= equal9 (fp.eq .15 (fp.mul .3 .11 .12))))
(assert (= equality11 (= .17 (fp.lt .14 .10))))
(assert (= equality2 (= .13 (fp.eq .11 .12))))
(assert (= equality4 (= .16 (fp.eq .14 .15))))
...
(assert (= nary-conjunction14 (and .13 (fp.eq .14 x) (= .13 (fp.eq .11 .12)) (= .16 (fp.eq .14 .15)) (fp.eq .10 ((_ to_fp 11 53) RTZ (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.eq .12 y) (fp.eq .15 (fp.mul .3 .11 .12)) (= .17 (fp.lt .14 .10)) (= .3 RNE) (fp.eq .11 z))))
(assert (= rounding-mode-equality12 (= .3 RNE)))
(assert (and .13 (fp.eq .14 x) (= .13 (fp.eq .11 .12)) (= .16 (fp.eq .14 .15)) (fp.eq .10 ((_ to_fp 11 53) RTZ (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.eq .12 y) (fp.eq .15 (fp.mul .3 .11 .12)) (= .17 (fp.lt .14 .10)) (= .3 RNE) (fp.eq .11 z)))
